...
namespace IonEngine {
	...
	public:
		...
		void setField(unsigned int index, bool value, unsigned int arrayIndex);
		void setField(unsigned int index, int value, unsigned int arrayIndex);
		void setField(unsigned int index, unsigned int value, unsigned int arrayIndex);
		void setField(unsigned int index, float value, unsigned int arrayIndex);
		void setField(unsigned int index, double value, unsigned int arrayIndex);
		void setField(unsigned int index, Vec2f value, unsigned int arrayIndex);
		void setField(unsigned int index, Vec3f value, unsigned int arrayIndex);
		void setField(unsigned int index, Vec4f value, unsigned int arrayIndex);
		void setField(unsigned int index, Color value, unsigned int arrayIndex);
		void setField(unsigned int index, Matrix4x4f value, unsigned int arrayIndex);
		void setField(unsigned int index, Vec2i value, unsigned int arrayIndex);
		void setField(unsigned int index, Vec3i value, unsigned int arrayIndex);
		void setField(unsigned int index, Vec4i value, unsigned int arrayIndex);
